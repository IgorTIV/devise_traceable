...
== Patch Details
  ...
  only one method modiified here lib/devise_traceable/model.rb & lib/devise_traceable/hooks/traceable.rb
  quick and dirty fix to to track user logins and logouts and for sti User model
